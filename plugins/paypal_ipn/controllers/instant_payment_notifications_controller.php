...
*/
      ...
      $transaccion = $this->InstantPaymentNotification->read();
      
      $exist = $this->Package->findByName($transaccion['InstantPaymentNotification']['item_name']);
      //echo $exist['Package']['price']." - ".$transaccion['InstantPaymentNotification']['mc_gross'];
      if(!empty($exist) && $exist['Package']['price']==$transaccion['InstantPaymentNotification']['mc_gross'])
      {
      	//echo "soopui[";exit();
      	...
      	$signup = array('Signup'=>array(
      		...
      		'profile_id'=>$transaccion['InstantPaymentNotification']['custom']
      	));
