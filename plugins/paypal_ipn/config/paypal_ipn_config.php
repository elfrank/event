...
class PaypalIpnConfig {
  ...
  /************
    ...
    */
  var $settings = array(
//    'business' => 'vizcaino.jimenez.manuel@gmail.com', //'live_email@paypal.com', //Your Paypal email account
    'business' => 'psell_1287872435_biz@danielvaldivia.com', //'live_email@paypal.com', //Your Paypal email account
    'server' => 'https://www.sandbox.paypal.com', //Main paypal server.
    'notify_url' => 'http://congreso.rebeet.com/paypal_ipn/process', //'http://www.yoursite.com/paypal_ipn/process', //Notify_url... set this to the process path of your paypal_ipn::instant_payment_notification::process action
  ...
  var $testSettings = array(
    'business' => 'psell_1287872435_biz@danielvaldivia.com', //'sandbox_email@paypal.com',
    'server' => 'https://www.sandbox.paypal.com',
    'notify_url' => 'http://congreso.rebeet.com/paypal_ipn/process', //'http://www.yoursite.com/paypal_ipn/process',
    'currency_code' => 'USD',
    'lc' => 'US',
