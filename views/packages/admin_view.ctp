...
<div class="actions">
	<ul>
		<li class="icon pencil"><?php echo $html->link(__('Edit Package', true), array('action' => 'admin_edit', $package['Package']['id'])); ?> </li>
		<li class="icon cross"><?php echo $html->link(__('Delete Package', true), array('action' => 'admin_delete', $package['Package']['id']), null, sprintf(__('Are you sure you want to delete package # %s?', true), $package['Package']['id'])); ?> </li>
	</ul>
</div>
